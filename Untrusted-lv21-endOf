/* THE GAME HASN'T ENDED YET, THIS IS HOW TO PASS THIS LEVEL:
Press [Ctrl]+[0] to open "Menu+"
Click on "scripts"
Click "objects.js"
Now find 'exit' and edit as below (line 94)*/
    ...
    return {
        ...
        'exit' : {
            ...
            'onCollision': function (player) {
                if (game.map.finalLevel) { // EDIT THIS LINE (Remove "!")
